...
namespace Compliance.Audio.API.Code
{
    public class Converter
    {
        ...
        private void Initialize()
        {
            ...
            {
                object o = ConfigurationManager.AppSettings["ffmpeg:ExecutablePath"];
                if (o == null)
                {
        ...
        {
            string tmpfile = Path.Combine(ConfigurationManager.AppSettings["ffmpeg:TempPath"], System.Guid.NewGuid().ToString() + ".mp3");
